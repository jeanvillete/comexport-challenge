...
Então 'deve ser calculado internamente um valor UUID que identifica o registro em questão'
	...
	E 'o registro em questão deve ser armazenado internamente'
	
	E 'o UUID calculado deve ser retornado para quem requisitou o armazenamento do registro ContaContabil'
